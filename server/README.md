...
DASHBOARD_EVENT_STRING_CAP=2048    # Longest string kept in a stored tool_input / tool_response (whole-file mirrors are always dropped); 0 stores payloads untouched
DASHBOARD_EVENT_FIELD_CAP=16384    # Byte budget per stored tool_input / tool_response after string trimming; over it only short scalars are kept
